...
const OfferDetailsModal: React.FC<OfferDetailsModalProps> = ({ offer, onClose }) => {
    if (!offer) {
        return null;
    }
        ...
        <Modal isOpen={true} onClose={onClose}>
            <ModalContent>
                ...
                <ModalBody>
                    ...
                    <p className="text-gray-600 mb-2">Business Phone Number: {offer.businessPhoneNumber}</p>
                    <p className="text-gray-600 mb-2">Business Email: {offer.businessEmail}</p>
